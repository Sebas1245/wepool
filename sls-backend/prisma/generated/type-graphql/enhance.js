...
const modelsInfo = {
    User: ["id", "createdAt", "updatedAt", "fname", "lname", "latitude", "longitude", "street", "number", "zipCode", "city", "state", "country", "phoneNumber", "carId", "companyId"],
    ...
    Ride: ["id", "kmToGoalLocation", "availableSeats", "status", "startsAt", "driverId"],
...
const outputsInfo = {
    ...
    UserGroupBy: ["id", "createdAt", "updatedAt", "fname", "lname", "latitude", "longitude", "street", "number", "zipCode", "city", "state", "country", "phoneNumber", "carId", "companyId", "_count", "_avg", "_sum", "_min", "_max"],
    ...
    RideGroupBy: ["id", "kmToGoalLocation", "availableSeats", "status", "startsAt", "driverId", "_count", "_avg", "_sum", "_min", "_max"],
    ...
    UserCountAggregate: ["id", "createdAt", "updatedAt", "fname", "lname", "latitude", "longitude", "street", "number", "zipCode", "city", "state", "country", "phoneNumber", "carId", "companyId", "_all"],
    ...
    UserMinAggregate: ["id", "createdAt", "updatedAt", "fname", "lname", "latitude", "longitude", "street", "number", "zipCode", "city", "state", "country", "phoneNumber", "carId", "companyId"],
    UserMaxAggregate: ["id", "createdAt", "updatedAt", "fname", "lname", "latitude", "longitude", "street", "number", "zipCode", "city", "state", "country", "phoneNumber", "carId", "companyId"],
    ...
    RideCountAggregate: ["id", "kmToGoalLocation", "availableSeats", "status", "startsAt", "driverId", "_all"],
    RideAvgAggregate: ["id", "kmToGoalLocation", "availableSeats", "driverId"],
    RideSumAggregate: ["id", "kmToGoalLocation", "availableSeats", "driverId"],
    RideMinAggregate: ["id", "kmToGoalLocation", "availableSeats", "status", "startsAt", "driverId"],
    RideMaxAggregate: ["id", "kmToGoalLocation", "availableSeats", "status", "startsAt", "driverId"],
...
const inputsInfo = {
    UserWhereInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "fname", "lname", "latitude", "longitude", "street", "number", "zipCode", "city", "state", "country", "phoneNumber", "carId", "companyId", "car", "driverRides", "passengerRides", "company"],
    UserOrderByWithRelationInput: ["id", "createdAt", "updatedAt", "fname", "lname", "latitude", "longitude", "street", "number", "zipCode", "city", "state", "country", "phoneNumber", "carId", "companyId", "car", "driverRides", "passengerRides", "company"],
    UserWhereUniqueInput: ["id", "carId"],
    UserOrderByWithAggregationInput: ["id", "createdAt", "updatedAt", "fname", "lname", "latitude", "longitude", "street", "number", "zipCode", "city", "state", "country", "phoneNumber", "carId", "companyId", "_count", "_avg", "_max", "_min", "_sum"],
    UserScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "fname", "lname", "latitude", "longitude", "street", "number", "zipCode", "city", "state", "country", "phoneNumber", "carId", "companyId"],
    ...
    RideWhereInput: ["AND", "OR", "NOT", "id", "kmToGoalLocation", "availableSeats", "status", "startsAt", "driverId", "driver", "passengers"],
    RideOrderByWithRelationInput: ["id", "kmToGoalLocation", "availableSeats", "status", "startsAt", "driverId", "driver", "passengers"],
    RideWhereUniqueInput: ["id"],
    RideOrderByWithAggregationInput: ["id", "kmToGoalLocation", "availableSeats", "status", "startsAt", "driverId", "_count", "_avg", "_max", "_min", "_sum"],
    RideScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "kmToGoalLocation", "availableSeats", "status", "startsAt", "driverId"],
    ...
    UserCreateInput: ["createdAt", "updatedAt", "fname", "lname", "latitude", "longitude", "street", "number", "zipCode", "city", "state", "country", "phoneNumber", "carId", "car", "driverRides", "passengerRides", "company"],
    UserUpdateInput: ["createdAt", "updatedAt", "fname", "lname", "latitude", "longitude", "street", "number", "zipCode", "city", "state", "country", "phoneNumber", "carId", "car", "driverRides", "passengerRides", "company"],
    UserCreateManyInput: ["id", "createdAt", "updatedAt", "fname", "lname", "latitude", "longitude", "street", "number", "zipCode", "city", "state", "country", "phoneNumber", "carId", "companyId"],
    UserUpdateManyMutationInput: ["createdAt", "updatedAt", "fname", "lname", "latitude", "longitude", "street", "number", "zipCode", "city", "state", "country", "phoneNumber", "carId"],
    ...
    RideCreateInput: ["kmToGoalLocation", "availableSeats", "status", "startsAt", "driver", "passengers"],
    RideUpdateInput: ["kmToGoalLocation", "availableSeats", "status", "startsAt", "driver", "passengers"],
    RideCreateManyInput: ["id", "kmToGoalLocation", "availableSeats", "status", "startsAt", "driverId"],
    RideUpdateManyMutationInput: ["kmToGoalLocation", "availableSeats", "status", "startsAt"],
    ...
    UserCountOrderByAggregateInput: ["id", "createdAt", "updatedAt", "fname", "lname", "latitude", "longitude", "street", "number", "zipCode", "city", "state", "country", "phoneNumber", "carId", "companyId"],
    UserAvgOrderByAggregateInput: ["id", "latitude", "longitude", "number", "zipCode", "carId", "companyId"],
    UserMaxOrderByAggregateInput: ["id", "createdAt", "updatedAt", "fname", "lname", "latitude", "longitude", "street", "number", "zipCode", "city", "state", "country", "phoneNumber", "carId", "companyId"],
    UserMinOrderByAggregateInput: ["id", "createdAt", "updatedAt", "fname", "lname", "latitude", "longitude", "street", "number", "zipCode", "city", "state", "country", "phoneNumber", "carId", "companyId"],
    ...
    RideCountOrderByAggregateInput: ["id", "kmToGoalLocation", "availableSeats", "status", "startsAt", "driverId"],
    RideAvgOrderByAggregateInput: ["id", "kmToGoalLocation", "availableSeats", "driverId"],
    RideMaxOrderByAggregateInput: ["id", "kmToGoalLocation", "availableSeats", "status", "startsAt", "driverId"],
    RideMinOrderByAggregateInput: ["id", "kmToGoalLocation", "availableSeats", "status", "startsAt", "driverId"],
    ...
    RideCreateWithoutDriverInput: ["kmToGoalLocation", "availableSeats", "status", "startsAt", "passengers"],
    ...
    RideScalarWhereInput: ["AND", "OR", "NOT", "id", "kmToGoalLocation", "availableSeats", "status", "startsAt", "driverId"],
    ...
    UserCreateWithoutCarInput: ["createdAt", "updatedAt", "fname", "lname", "latitude", "longitude", "street", "number", "zipCode", "city", "state", "country", "phoneNumber", "carId", "driverRides", "passengerRides", "company"],
    UserCreateOrConnectWithoutCarInput: ["where", "create"],
    UserUpsertWithoutCarInput: ["update", "create"],
    UserUpdateWithoutCarInput: ["createdAt", "updatedAt", "fname", "lname", "latitude", "longitude", "street", "number", "zipCode", "city", "state", "country", "phoneNumber", "carId", "driverRides", "passengerRides", "company"],
    UserCreateWithoutCompanyInput: ["createdAt", "updatedAt", "fname", "lname", "latitude", "longitude", "street", "number", "zipCode", "city", "state", "country", "phoneNumber", "carId", "car", "driverRides", "passengerRides"],
    ...
    UserScalarWhereInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "fname", "lname", "latitude", "longitude", "street", "number", "zipCode", "city", "state", "country", "phoneNumber", "carId", "companyId"],
    UserCreateWithoutDriverRidesInput: ["createdAt", "updatedAt", "fname", "lname", "latitude", "longitude", "street", "number", "zipCode", "city", "state", "country", "phoneNumber", "carId", "car", "passengerRides", "company"],
    ...
    UserUpdateWithoutDriverRidesInput: ["createdAt", "updatedAt", "fname", "lname", "latitude", "longitude", "street", "number", "zipCode", "city", "state", "country", "phoneNumber", "carId", "car", "passengerRides", "company"],
    ...
    UserCreateWithoutPassengerRidesInput: ["createdAt", "updatedAt", "fname", "lname", "latitude", "longitude", "street", "number", "zipCode", "city", "state", "country", "phoneNumber", "carId", "car", "driverRides", "company"],
    UserCreateOrConnectWithoutPassengerRidesInput: ["where", "create"],
    RideCreateWithoutPassengersInput: ["kmToGoalLocation", "availableSeats", "status", "startsAt", "driver"],
    RideCreateOrConnectWithoutPassengersInput: ["where", "create"],
    UserUpsertWithoutPassengerRidesInput: ["update", "create"],
    UserUpdateWithoutPassengerRidesInput: ["createdAt", "updatedAt", "fname", "lname", "latitude", "longitude", "street", "number", "zipCode", "city", "state", "country", "phoneNumber", "carId", "car", "driverRides", "company"],
    RideUpsertWithoutPassengersInput: ["update", "create"],
    RideUpdateWithoutPassengersInput: ["kmToGoalLocation", "availableSeats", "status", "startsAt", "driver"],
    RideCreateManyDriverInput: ["id", "kmToGoalLocation", "availableSeats", "status", "startsAt"],
    RidePassengersCreateManyPassengerInput: ["id", "createdAt", "rideId"],
    RideUpdateWithoutDriverInput: ["kmToGoalLocation", "availableSeats", "status", "startsAt", "passengers"],
    RidePassengersUpdateWithoutPassengerInput: ["createdAt", "ride"],
    UserCreateManyCompanyInput: ["id", "createdAt", "updatedAt", "fname", "lname", "latitude", "longitude", "street", "number", "zipCode", "city", "state", "country", "phoneNumber", "carId"],
    UserUpdateWithoutCompanyInput: ["createdAt", "updatedAt", "fname", "lname", "latitude", "longitude", "street", "number", "zipCode", "city", "state", "country", "phoneNumber", "carId", "car", "driverRides", "passengerRides"],
